...
export function Footer() {
  ...
  return (
    <>
      {/* Mobile Footer — Scan page minimal style */}
      <footer className="w-full pt-8 pb-6 px-4 text-center text-xs text-[color:var(--color-clinic-muted)] sm:hidden">
        © {new Date().getFullYear()} SiagaSehat. Fitur ini tidak menggantikan konsultasi medis profesional.
      </footer>

      {/* Desktop / Tablet Rich Footer */}
      <footer id="contact" className="hidden sm:block w-full bg-[#f7f4ee] px-3 pb-4 pt-8 sm:px-4 md:px-8 md:pb-2 md:pt-10">
