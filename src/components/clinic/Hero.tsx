    ...
    <>
      ...
      <section className="relative w-full overflow-hidden bg-white px-3.5 pt-3 pb-8 sm:px-6 sm:pt-4 md:px-8 md:pt-6 md:pb-12 lg:px-10 lg:pt-8 lg:pb-16 xl:pt-10 xl:pb-20">
        ...
        <div className="relative mx-auto max-w-6xl xl:max-w-7xl w-full">
          <div className="relative mt-4 grid gap-7 sm:mt-6 sm:gap-10 min-[900px]:grid-cols-[0.92fr_1.08fr_0.9fr] min-[900px]:items-start min-[900px]:gap-5 xl:grid-cols-[1fr_1.1fr_0.9fr] xl:gap-8">
              ...
              <div className="relative inline-flex items-end justify-center w-full max-w-[280px] sm:max-w-[360px] min-[900px]:max-w-none">
                ...
                >
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <div className="relative grid h-10 w-10 shrink-0 place-items-center rounded-full border-4 border-[color:var(--color-clinic-blue)]/20">
