    ...
    <main className="min-h-screen bg-[#f7f4ee] pb-16 font-sans">
      <div className="hex-pattern relative overflow-hidden bg-[color:var(--color-clinic-blue)] px-6 pb-24 pt-6 md:px-10 md:pt-8">
        <header className="relative z-10 flex items-center justify-between gap-4">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-4 py-2 text-xs font-medium text-white backdrop-blur transition hover:bg-white/25"
          >
        ...
        <div className="relative z-10 mx-auto mt-8 max-w-2xl text-center md:mt-12">
          <span className="animate-fade-up inline-flex items-center gap-1.5 rounded-full bg-white/15 px-4 py-1.5 text-xs font-medium text-white backdrop-blur">
            <Sparkles className="h-3.5 w-3.5" />
            Didukung oleh Kecerdasan Buatan
          </span>
          <h1
            className="animate-fade-up mt-4 font-display text-4xl font-extrabold leading-tight text-white md:text-5xl"
            style={{ animationDelay: "0.05s" }}
          >
            Scan Penyakit AI
          </h1>
          <p
            className="animate-fade-up mx-auto mt-3 max-w-lg text-sm leading-relaxed text-white/80 md:text-base"
            style={{ animationDelay: "0.1s" }}
          >
            Unggah atau foto langsung kondisi kulit/tubuhmu — AI kami akan menganalisis dan
            memberikan skrining kesehatan awal secara instan.
          </p>
        </div>
      </div>
