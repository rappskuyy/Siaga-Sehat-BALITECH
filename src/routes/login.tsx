  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f0f3f9] px-3 py-6 font-sans sm:px-6 sm:py-10">
      ...
      >
        ...
        <div className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between p-8 xl:p-10">
            ...
            <div className="max-w-md">
              ...
              >
                Masuk untuk melanjutkan konsultasi, memantau riwayat scan AI, dan mengelola
                pengingat obat kamu.
              </motion.p>
          ...
          >
            <img
              ...
              className="h-[230px] w-auto object-contain drop-shadow-2xl xl:h-[270px]"
            />
          </motion.div>

          {/* Floating mini stat cards, overlapping the illustration */}
          <div className="pointer-events-none absolute bottom-8 left-8 z-20 flex gap-3 xl:left-10">
            {FLOATING_STATS.map((s, i) => (
              <motion.div
                ...
                className="animate-float flex items-center gap-2.5 rounded-2xl bg-white/[0.09] px-4 py-2.5 backdrop-blur-sm border border-white/10"
        ...
        {/* Right — form panel */}
        <div className="relative flex flex-col justify-center bg-white px-6 py-10 sm:px-10 lg:px-12 xl:px-14">
          <Link
            to="/"
          ...
          <motion.div
            ...
            className="mx-auto w-full max-w-sm pt-10 lg:pt-0"
          >
            ...
            <form onSubmit={handleSubmit} className="mt-7 flex flex-col gap-4">
              ...
              >
                <Button
                  type="submit"
                  disabled={loading}
                  className="mt-2 w-full h-11 gap-2 rounded-full bg-[color:var(--color-clinic-blue)] font-semibold hover:bg-[color:var(--color-clinic-blue-dark)] shadow-lg shadow-[color:var(--color-clinic-blue)]/20 transition-all duration-300 hover:shadow-xl hover:shadow-[color:var(--color-clinic-blue)]/30 cursor-pointer"
                >
            ...
            >
              <Link
                to="/register"
                className="mt-5 flex items-center justify-center gap-2 rounded-full border border-black/10 bg-white px-4 py-2.5 text-sm font-semibold text-[color:var(--color-clinic-ink)] shadow-2xs transition-all duration-300 hover:border-[color:var(--color-clinic-blue)]/30 hover:shadow-md group"
              >
                Buat Akun Baru
